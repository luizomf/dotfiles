...
M.set_groups = function()
  ...
  vim.api.nvim_set_hl(0, "NonText", { fg = p.gray_08 })
  ...
  vim.api.nvim_set_hl(0, "CursorLineNr", { bold = true, fg = p.orange })
  ...
  vim.api.nvim_set_hl(0, "Title", { bold = true, fg = p.blue, bg = p.red })
  ...
  vim.api.nvim_set_hl(0, "Whitespace", { fg = p.gray_04 })

...
# Git prompt config
ZSH_THEME_GIT_PROMPT_PREFIX="${BG_YELLOW} ${FG_BLACK}("
ZSH_THEME_GIT_PROMPT_SUFFIX="${BG_YELLOW}${FG_BLACK})${RESET_ALL}"
ZSH_THEME_GIT_PROMPT_DIRTY="${FG_RED} ✘${RESET_ALL}"
ZSH_THEME_GIT_PROMPT_CLEAN="${FG_GREEN} ✔${RESET_ALL}"

# Prompt principal
PROMPT='${BG_BLUE}${FG_BLACK} %-2d ${RESET_ALL}'
PROMPT+='${FG_BLUE}${BG_YELLOW}${RESET_ALL}$(git_prompt_info)${FG_YELLOW}${RESET_ALL}'
